onload= getProducts;
                   ...
                   for (let i=0; i<productList.length;i++) {
                       ...
                       document.getElementById("productList").innerHTML += `
                        <div class="col-sm-4">
                          ...
                          <h1 align="left">Id:</h1><input disabled value="${product._id}" id="${product._id}_id"/ >
                          <h1 align="left">Name:</h1> <input disabled value="${product.name}" id="${product._id}name"/>
                          <h1 align="left">Color:</h1> <input disabled type=color value="${product.color}" id="${product._id}color" />
       ...
       function saveChanges(product) {
        ...
        document.getElementById(product._id+"color").setAttribute("disabled",true);
        document.getElementById(product._id+"save").style.display="none";
        
        let body={
            "name":document.getElementById(product._id+"name").value,
            "color":document.getElementById(product._id+"color").value
        };
       ...
       function editProduct(product) {
        ...
        document.getElementById(product._id+"color").removeAttribute("disabled");
       }
